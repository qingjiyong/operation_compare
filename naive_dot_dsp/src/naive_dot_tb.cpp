...
const std::string parent_dir = "/home/percy/data/HDL/naive_dot/src/testbench";
...
int main(){
    ...
    // Call the naive_dot function
    naive_dot(rounds, data, weight, result);
